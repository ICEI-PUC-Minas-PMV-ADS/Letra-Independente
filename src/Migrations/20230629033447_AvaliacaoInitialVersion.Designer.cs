...
namespace src.Migrations
{
    ...
    [Migration("20230629033447_AvaliacaoInitialVersion")]
    partial class AvaliacaoInitialVersion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("src.Models.Avaliacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("src.Models.Avaliacao", b =>
                {
                    b.HasOne("src.Models.Texto", "Texto")
                        .WithMany("Avaliacao")
                        .HasForeignKey("IdTexto")
